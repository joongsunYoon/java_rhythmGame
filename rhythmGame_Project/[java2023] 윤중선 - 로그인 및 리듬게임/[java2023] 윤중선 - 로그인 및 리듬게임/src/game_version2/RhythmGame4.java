...
// 홈페이지 : https://archive.org/details/La_campanella 
// https://ia800709.us.archive.org/29/items/La_campanella/Liszt___Paganini_-_Etude_No.3__La_campanella_.mp3
// 787.p Clip 만들기 
// Clip과 AudioStream을 사용하여 wav 재생

public class RhythmGame4 extends JFrame{
	...
	class TileMap{
		...
		public void init(){
			...
			for(int i = 0 ; i < size ; i++){						
				tileMap.add(new Tile( width/4 * r.nextInt(4) , -i * 10 - 40 ));
			}
		}
