...
//Tile이 적정한 높이에 있을때 키 입력을 하여 점수를 얻을 수 있는 메소드 작성
//getScore작성 중 key값을 일치시켜야 하는것을 알게되어 Tile에게서 타일이 어느라인에 있는지 알 수 있는 메소드 작성

public class RhythmGame5 extends JFrame{

	TileMap tiles = new TileMap(10);
	private Clip clip;
